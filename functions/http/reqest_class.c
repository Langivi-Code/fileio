...
zend_class_entry *register_class_HttpRequest(void) {
    ...
    MODULE_GL(http_request_class) = zend_register_internal_class_ex(&ce, NULL);
    MODULE_GL(http_request_class)->ce_flags |= ZEND_ACC_NO_DYNAMIC_PROPERTIES;

    zval method;
    ZVAL_UNDEF(&method);
    register_property(MODULE_GL(http_request_class), PROP("method"), &method, ZEND_ACC_PUBLIC | ZEND_ACC_READONLY,
                      MAY_BE_STRING);
    zval HttpVersion;
    ZVAL_UNDEF(&HttpVersion);
    register_property(MODULE_GL(http_request_class), PROP("HttpVersion"), &HttpVersion,
                      flags_pb_ro, MAY_BE_STRING);
    zval uri;
    ZVAL_UNDEF(&uri);
    register_property(MODULE_GL(http_request_class), PROP("uri"), &uri,
                      flags_pb_ro, MAY_BE_STRING);
    zval querystring;
    ZVAL_UNDEF(&querystring);
    register_property(MODULE_GL(http_request_class), PROP("querystring"), &uri,
                      flags_pb_ro, MAY_BE_STRING);
    zval body;
    ZVAL_UNDEF(&body);
    register_property(MODULE_GL(http_request_class), PROP("body"), &body, flags_pb_ro,
                      MAY_BE_ARRAY);
    zval headers;
    ZVAL_UNDEF(&headers);
    register_property(MODULE_GL(http_request_class), PROP("headers"), &headers, flags_pb_ro,
                      MAY_BE_ARRAY);
    zval query;
    ZVAL_UNDEF(&query);
    register_property(MODULE_GL(http_request_class), PROP("query"), &query, flags_pb_ro,
                      MAY_BE_ARRAY);
